...
public class week06TicTacToeGame {
	...
	// This Lab requires you to program a simple game of Tic Tac Toe
		...
		//
		//					b. Another option for the gameBoard would be a 2nd array -- This option might be
		...
		public static void main(String[] args) {
				...
				System.out.println("See GameBoard class which contains the actual game, main, and methods.");
